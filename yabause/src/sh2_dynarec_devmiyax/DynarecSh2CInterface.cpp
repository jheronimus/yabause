...
void memSetByteNoCache(u32 addr, u8 data)
{
  ...
  case 0x00200000:
    ...
    DynarecSh2::CurrentContext->memcycle_ += getMemWriteClock(addr, 1);
    dynaFree();
    return;
    break;
    // High Memory
...
void memSetWordNoCache(u32 addr, u16 data)
{
  ...
  case 0x00200000:
    ...
    DynarecSh2::CurrentContext->memcycle_ += getMemWriteClock(addr, 2);
    dynaFree();
    return;
    break;
    // High Memory
...
void memSetLongNoCache(u32 addr, u32 data)
{
  ...
  case 0x00200000:
    ...
    DynarecSh2::CurrentContext->memcycle_ += getMemWriteClock(addr, 4);
    dynaFree();
    return;
    break;
    // High Memory
