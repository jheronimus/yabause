...
public:
  ...
  virtual bool addCodeBreakpointEx(u32 addr, int regIndex, u32 regValue);
  virtual bool delCodeBreakpoint(u32 addr);
  virtual bool addMemoryBreakpoint(u32 addr, u32 flags, u32 value,
                                   int checkValue);
...
protected slots:
  ...
  void on_cbValueCondition_toggled(bool enable);
  void on_cbRegCondition_currentIndexChanged(int index);
